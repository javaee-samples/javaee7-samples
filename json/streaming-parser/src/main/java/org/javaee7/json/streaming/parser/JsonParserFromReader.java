...
public class JsonParserFromReader extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Streaming Reading of JSON from Reader</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            json = "{"
                    ...
                    + "  \"banana\":\"yellow\""
                    + "}";
            out.println("<br><br>Reading an object with two elements " + json + "<br>");
            jsonParser = Json.createParser(new StringReader(json));
            parseEvents(jsonParser, out);
            ...
            json = "["
                    ...
                    + "  { \"banana\":\"yellow\" }"
                    + "]";
            out.println("<br><br>Reading an array with two objects " + json + "<br>");
            jsonParser = Json.createParser(new StringReader(json));
            parseEvents(jsonParser, out);
            ...
            json = "{"
                    ...
                    + "  ]"
                    + "}";
            out.println("<br><br>Reading a nested structure " + json + "<br>");
            jsonParser = Json.createParser(new StringReader(json));
            parseEvents(jsonParser, out);
