...
public class TestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Extended Persistence Context</title>");
        out.println("</head>");
        out.println("<body>");
        out.println("<h1>Extended Persistence Context</h1>");
        listEmployees(out, "Initial list", "Total == 7?");
        Employee e = new Employee(8, "Priya");
        bean.persistWithoutTransaction(e);
        listEmployees(out, "PC without a transaction", "Total == 7?");
        bean.persistWithTransaction(e);
        listEmployees(out, "PC with a transaction", "Total == 8?");
        out.println("</body>");
        out.println("</html>");
    }
