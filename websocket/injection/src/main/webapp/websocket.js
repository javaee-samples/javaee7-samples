...
var wsEJBUri = "ws://" + document.location.host + document.location.pathname + "websocket-ejb";
...
var wsCDIUri = "ws://" + document.location.host + document.location.pathname + "websocket-cdi";
...
function sayHelloEJB() {
    websocketEJB.send(myField.value);
    writeToScreen("SENT (ejb): " + myField.value);
}

function sayHelloCDI() {
    websocketCDI.send(myField.value);
    writeToScreen("SENT (cdi): " + myField.value);
}

function onOpenEJB() {
    writeToScreen("CONNECTED (ejb)");
}
